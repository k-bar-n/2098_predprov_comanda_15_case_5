...
3.  **Разработка:**
    ...
    - **Реализация функций для работы с JSON:**
      - Функции для чтения JSON-файлов (реализовано частично для некоторых из данных файлов).
      - Функции для записи в JSON-файлы (реализовано частично для некоторых из данных файлов).
    - **Реализация функций авторизации/регистрации:**
      - Проверка наличия пользователя в `users.json` (реализовано частично при авторизации и регистрации).
      - Сравнение введенных данных с данными в JSON-файле (реализовано частично при авторизации и регистрации).
